...
void EnemyHP::Init()
{
	...
	vertex[3].Position = D3DXVECTOR3(320, 150, 0.0f);
...
void EnemyHP::Draw()
{
	...
	vertex[0].Position = D3DXVECTOR3(20.0f, 20.0f, 0.0f);
	vertex[0].Normal = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
	vertex[0].Diffuse = D3DXVECTOR4(1.0f, 1.0f, 1.0f, 1.0f);
	vertex[0].TexCoord = D3DXVECTOR2(0.0f, 0.0f);

	vertex[1].Position = D3DXVECTOR3(20.0f + (m_Percentage * m_Max), 20.0f, 0.0f);
	vertex[1].Normal = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
	vertex[1].Diffuse = D3DXVECTOR4(1.0f, 1.0f, 1.0f, 1.0f);
	vertex[1].TexCoord = D3DXVECTOR2(1.0f, 0.0f);

	vertex[2].Position = D3DXVECTOR3(20.0f, 50.0f, 0.0f);
	vertex[2].Normal = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
	vertex[2].Diffuse = D3DXVECTOR4(1.0f, 1.0f, 1.0f, 1.0f);
	vertex[2].TexCoord = D3DXVECTOR2(0.0f, 1.0f);

	vertex[3].Position = D3DXVECTOR3(0.0f + (m_Percentage * m_Max), 50.0f, 0.0f);
	vertex[3].Normal = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
	vertex[3].Diffuse = D3DXVECTOR4(1.0f, 1.0f, 1.0f, 1.0f);
	vertex[3].TexCoord = D3DXVECTOR2(1.0f, 1.0f);
	...
	lostVertex[0].Position = D3DXVECTOR3(20.0f + (m_Percentage * m_Max), 20.0f, 0.0f);
	...
	lostVertex[1].Position = D3DXVECTOR3(20.0f + m_Max, 20.0f, 0.0f);
	...
	lostVertex[2].Position = D3DXVECTOR3(m_Percentage * m_Max, 50.0f, 0.0f);
	...
	lostVertex[3].Position = D3DXVECTOR3(m_Max, 50.0f, 0.0f);
...
float EnemyHP::SetDamage(float damage)
{
	m_Current -= damage;
	return m_Current;
}
